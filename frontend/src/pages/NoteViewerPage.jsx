      ...
      <div className="max-w-3xl mx-auto">
        <div className="flex items-center justify-between gap-3 mb-6 flex-wrap">
          ...
          <button
            ...
            disabled={generating}
            className="bg-gradient-to-r from-pink-400 to-blue-500 text-white rounded-2xl px-4 sm:px-5 py-2 sm:py-2.5 text-sm flex items-center gap-2 hover:opacity-90 disabled:opacity-50 transition-opacity font-bold"
