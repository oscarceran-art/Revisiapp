        ...
        <div className="grid md:grid-cols-[280px_1fr] gap-8">
          ...
          <div>
            <button
              ...
              className="w-full btn-gradient-sweep rounded-2xl py-2.5 px-4 flex items-center justify-center gap-2 active:scale-[0.98] mb-3"
            ...
            {showNew && (
              <div className="border border-black/15 rounded-2xl p-3 mb-3 bg-white">
                ...
                <div className="flex gap-2 mt-2">
                  <button onClick={handleCreate} className="text-sm btn-gradient-sweep rounded-xl px-3 py-1.5 active:scale-[0.98]" data-testid="confirm-subject-btn">Add</button>
              ...
              <div className="bg-white border border-black/10 rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8" data-testid="subject-editor">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-6">
                  ...
                  <div className="flex items-center gap-2 w-full sm:w-auto">
                    ...
                    <button onClick={handleSave} disabled={saving} className="btn-gradient-sweep rounded-2xl px-4 py-2 text-sm flex items-center gap-2 disabled:opacity-50 active:scale-[0.98]" data-testid="save-subject-btn">
